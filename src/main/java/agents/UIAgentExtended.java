...
public class UIAgentExtended extends Agent {
	...
	private EnterBidDialogExtended getDialog() throws Exception {
		EnterBidDialogExtended ui = new EnterBidDialogExtended(this, null, true,
				(AdditiveUtilitySpace) utilitySpace, lastReceivedBid);
	...
	public void ReceiveMessage(Action opponentAction) {
		...
		if (opponentAction instanceof Offer) {
			lastReceivedBid = ((Offer) opponentAction).getBid();
		}
		return;
	}
	...
	public Action chooseAction() {
		...
		return null; // too bad, this will report the bug.
	}
	...
	public String getDescription() {
		return "Human user interface to place bids";
	}
