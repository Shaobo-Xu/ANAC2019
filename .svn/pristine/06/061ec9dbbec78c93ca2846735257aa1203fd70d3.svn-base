...
public class AverageTitForTatOfferingGamma1 extends OfferingStrategy {
	...
	public AverageTitForTatOfferingGamma1(NegotiationSession negotiationSession, OpponentModel opponentModel, OMStrategy omStrategy) {
