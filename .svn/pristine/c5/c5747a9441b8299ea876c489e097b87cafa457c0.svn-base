...
public class AverageTitForTat2 extends BOAagentBilateral {
	...
	public void agentSetup() {
		...
		offeringStrategy = new AverageTitForTatOfferingGamma2(negotiationSession, opponentModel, omStrategy);
	...
	public String getName() {
		return "AverageTitForTat with gamma 2";
	}
